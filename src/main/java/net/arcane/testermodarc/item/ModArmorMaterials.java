...
public enum ModArmorMaterials implements ArmorMaterial {
    SOUL_SAPPHIRE("soul_sapphire",26, new int[]{5, 7, 5, 4}, 25,
            SoundEvents.ARMOR_EQUIP_DIAMOND, 1f, 0f, () -> Ingredient.of(ModItems.SOUL_SAPPHIRE.get()))
    ;
    ...
    public String getName() {
        return TesterModArc.MOD_ID + ":" + this.name;
    }
